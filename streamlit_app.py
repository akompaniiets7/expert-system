...
manual_order = [
    "Вступ. Зміст предмета «Матеріалознавство»",
    "Кристалічна будова металів. Засоби її досягнення."
    "Основні властивості металів.",
    "Причини руйнування деталей.",
    "Методи фізико-хімічного аналізу металів."  # ця — остання
]

# Відбираємо лише ті теми, які є у завантажених тестах
topics = [t for t in manual_order if t in tests]
